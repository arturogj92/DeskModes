...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func rebuildMenu() {
        ...
        // Header
        let header = NSMenuItem(title: "DeskModes", action: nil, keyEquivalent: "")
        ...
        if let current = currentMode {
            let currentItem = NSMenuItem(title: "Current: \(current.name)", action: nil, keyEquivalent: "")
        ...
        // Modes
        let modesHeader = NSMenuItem(title: "Switch Mode:", action: nil, keyEquivalent: "")
    ...
    func switchToMode(_ mode: Mode) {
        print("[DeskModes] === Mode switch started: \(mode.name) ===")
        ...
        print("[DeskModes] Closed: \(closed.joined(separator: ", "))")
        print("[DeskModes] Skipped: \(skipped.joined(separator: ", "))")
        print("[DeskModes] Opened: \(opened.joined(separator: ", "))")
        print("[DeskModes] === Mode switch completed ===")
